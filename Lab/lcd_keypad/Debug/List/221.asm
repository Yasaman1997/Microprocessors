...
; 0000 0034 DDRC=(0<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	LDI  R30,LOW(112)
	OUT  0x14,R30
...
; 0000 003A DDRD=(0<<DDD7) | (1<<DDD6) | (1<<DDD5) | (1<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(112)
	OUT  0x11,R30
...
; 0000 009C           delay_ms(50);
	...
	LDI  R27,0
	CALL _delay_ms
; 0000 009D           if(PINC.0 == 1)
	SBIS 0x13,0
	RJMP _0x8
; 0000 009E             lcd_puts("3");
	__POINTW2MN _0x9,0
	RCALL _lcd_puts
; 0000 009F           PORTD.5 = 1;
_0x8:
