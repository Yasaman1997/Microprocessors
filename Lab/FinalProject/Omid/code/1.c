...
// Function: Bit7=Out Bit6=In Bit5=In Bit4=In Bit3=In Bit2=Out Bit1=In Bit0=In 
DDRD=(1<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
// State: Bit7=0 Bit6=T Bit5=T Bit4=T Bit3=T Bit2=0 Bit1=T Bit0=T 
...
while (1)
      {      
             ...
             threshold = read_adc(0)*(0.48828125);
             temperature = read_adc(1)*(0.48828125);
     
     
       
             // sprintf(str,"ADC0:%04u", read_adc(1));     
             // str[0]='n';
            //  puts(str);  
            lcd_puts("Threshold : ");
            itoa(threshold, buffer);
            lcd_puts(buffer);         
            
            lcd_gotoxy(0,1); 
            lcd_puts("Temperature : ");
            itoa(temperature , buffer);
            lcd_puts(buffer);
