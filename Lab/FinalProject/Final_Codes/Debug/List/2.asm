...
_0x0:
	.DB  0x68,0x65,0x6C,0x6C,0x6C,0x6F,0x6C,0x0
...
; 0000 008B // USART Baud Rate: 9600
; 0000 008C UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 008D UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (0<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(8)
	OUT  0xA,R30
...
; 0000 009B // ADC Clock frequency: 1000.000 kHz
; 0000 009C // ADC Voltage Reference: AREF pin
; 0000 009D // ADC Auto Trigger Source: Free Running
; 0000 009E ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(0)
	OUT  0x7,R30
; 0000 009F ADCSRA=(1<<ADEN) | (0<<ADSC) | (1<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(163)
	OUT  0x6,R30
; 0000 00A0 SFIOR=(0<<ADTS2) | (0<<ADTS1) | (0<<ADTS0);
	LDI  R30,LOW(0)
	OUT  0x30,R30
; 0000 00A1 
...
; 0000 00AD // RS - PORTC Bit 2
; 0000 00AE // RD - PORTC Bit 3
; 0000 00AF // EN - PORTC Bit 4
; 0000 00B0 // D4 - PORTC Bit 5
; 0000 00B1 // D5 - PORTC Bit 6
; 0000 00B2 // D6 - PORTC Bit 7
; 0000 00B3 // D7 - PORTD Bit 2
