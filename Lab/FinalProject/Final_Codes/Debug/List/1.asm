...
_main:
; .FSTART _main
; 0000 0037      char buffer[7];
; 0000 0038 char str[20];
; 0000 0039 
...
; 0000 004A // Function: Bit7=Out Bit6=Out Bit5=Out Bit4=Out Bit3=Out Bit2=Out Bit1=In Bit0=In
; 0000 004B DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (0<<DDC3) | (0<<DDC2) | (0<<DDC1) | (0<<DDC0);
	OUT  0x14,R30
; 0000 004C // State: Bit7=0 Bit6=0 Bit5=0 Bit4=0 Bit3=0 Bit2=0 Bit1=T Bit0=T
; 0000 004D PORTC=(0<<PORTC7) | (0<<PORTC6) | (0<<PORTC5) | (0<<PORTC4) | (0<<PORTC3) | (0<<PORTC2) | (0<<PORTC1) | (0<<PORTC0);
	OUT  0x15,R30
; 0000 004E 
; 0000 004F // Port D initialization
; 0000 0050 // Function: Bit7=Out Bit6=In Bit5=In Bit4=In Bit3=In Bit2=Out Bit1=In Bit0=In
; 0000 0051 DDRD=(1<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	LDI  R30,LOW(128)
	OUT  0x11,R30
; 0000 0052 // State: Bit7=0 Bit6=T Bit5=T Bit4=T Bit3=T Bit2=0 Bit1=T Bit0=T
...
; 0000 008F UCSRA=(0<<RXC) | (0<<TXC) | (0<<UDRE) | (0<<FE) | (0<<DOR) | (0<<UPE) | (0<<U2X) | (0<<MPCM);
	OUT  0xB,R30
; 0000 0090 UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (0<<RXEN) | (1<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(8)
	OUT  0xA,R30
...
; 0000 009E // ADC Clock frequency: 1000.000 kHz
; 0000 009F // ADC Voltage Reference: AREF pin
; 0000 00A0 // ADC Auto Trigger Source: Free Running
; 0000 00A1 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(0)
	OUT  0x7,R30
; 0000 00A2 ADCSRA=(1<<ADEN) | (0<<ADSC) | (1<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(163)
	OUT  0x6,R30
...
; 0000 00B0 // RS - PORTC Bit 2
; 0000 00B1 // RD - PORTC Bit 3
; 0000 00B2 // EN - PORTC Bit 4
; 0000 00B3 // D4 - PORTC Bit 5
; 0000 00B4 // D5 - PORTC Bit 6
; 0000 00B5 // D6 - PORTC Bit 7
; 0000 00B6 // D7 - PORTD Bit 2
...
; 0000 00BD       lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 00BE      // lcd_putsf("YASAMAN");
; 0000 00BF        // delay_ms(500);
; 0000 00C0               PORTD.7=1;
	SBI  0x12,7
; 0000 00C1              // sprintf(str,"ADC0:%04u", read_adc(1));
; 0000 00C2              // str[0]='n';
; 0000 00C3             //  puts(str);
; 0000 00C4 
; 0000 00C5             itoa(read_adc(0), buffer);
	LDI  R26,LOW(0)
	RCALL _read_adc
	ST   -Y,R31
	ST   -Y,R30
	...
	ADIW R26,22
	CALL _itoa
; 0000 00C6             lcd_puts(buffer);
	MOVW R26,R28
	ADIW R26,20
	CALL _lcd_puts
; 0000 00C7             delay_ms(30);
	LDI  R26,LOW(30)
	LDI  R27,0
	CALL _delay_ms
; 0000 00C8       }
